 ...
 *
 */
public class ManutencaoFamiliaStrategyAplicandoPontuacao implements ManutencaoFamiliaStrategy, ManutencaoFamiliarValidacao, ManutencaoFamiliarCriterios {

	@Override
	public FamiliaPO executar(FamiliaDTO familiaDTO) throws PasqualiException {
		validar(familiaDTO);
		FamiliaPO familiaPO = aplicarTodosCriterios(criarFamiliaPO(familiaDTO));
		return familiaPO;
	}
